	...
	public final class OrderServiceClient {
	    ...
	    public static void main(String args[]) throws Exception {
	       ...
	       //Configuring the CXF logging interceptor for the incoming response
	         ...
	         getClient = getClient.accept("application/json").type("application/json").path("/orderservice/order/111");
	        ...
	        *****************************************************************************************/
	        ...
	        //orderRequest.setorderID("111");
	        //orderRequest.setCustomerid(11);
	        //orderRequest.setStatus("shipped");
...
//	        
	        ...
	        *****************************************************************************************/
	        ...
	        // change application/xml  to application/json get in json format
	        deleteClient = deleteClient.accept("application/xml").type("application/json").path("/orderservice/order/111");
